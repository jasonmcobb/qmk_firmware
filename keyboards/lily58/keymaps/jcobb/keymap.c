...
[_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_DEL,      KC_BSPC,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
            KC_LALT,KC_LCTRL,KC_LOWER, KC_ENT,      KC_SPC,  KC_RAISE, KC_RCTRL, KC_RALT \
    ),
/*
 * GAMING
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_GAMING] = LAYOUT( \
    ...
    KC_LALT, KC_LCTL, KC_LOWER, KC_SPC,             KC_ENT, KC_RAISE, KC_RCTL, KC_RALT \
    ),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
    ...
    KC_TRNS,KC_EXLM,KC_AT,KC_HASH,KC_DLR,KC_LPRN,                       KC_RPRN,KC_1,KC_2,KC_3,KC_NO,KC_F12,
    KC_TRNS,KC_PERC,KC_AMPR,KC_MINS,KC_EQL,KC_LCBR,                     KC_RCBR,KC_4,KC_5,KC_6,KC_0,KC_DEL,
    KC_TRNS,KC_CIRC,KC_ASTR,KC_UNDS,KC_PLUS,KC_LBRC,KC_TRNS,      KC_TRNS,KC_RBRC,KC_7,KC_8,KC_9,KC_NO,KC_TRNS,
...
[_RAISE] = LAYOUT( \
    KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                         KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, \
    KC_NO, KC_NO, LCTL(LSFT(KC_TAB)), LCTL(KC_UP), LCTL(KC_TAB), KC_NO,                          KC_NO, KC_PRVWD, KC_UP, KC_NXTWD, KC_NO, KC_F12, \
    KC_TRNS, KC_NO, LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_RIGHT), KC_NO,                        KC_LSTRT, KC_LEFT, KC_DOWN, KC_RGHT, KC_LEND, KC_NO, \
    KC_TRNS, KC_NO, KC_NO, KC_NO, KC_JBFOLD, KC_JBTERM, KC_TRNS,        KC_TRNS, KC_DLINE, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS \
    ),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ADJUST] = LAYOUT( \
    ...
    KC__VOLUP, KC_NO, KC_NO, KC_NO, KC__VOLUP, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC__MUTE, KC_NO, KC_NO, KC_NO, KC__MUTE, KC_NO,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC__VOLDOWN, KC_NO, KC_NO, KC_NO, KC__VOLDOWN, KC_NO, KC_NO,         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS \
    )
};
