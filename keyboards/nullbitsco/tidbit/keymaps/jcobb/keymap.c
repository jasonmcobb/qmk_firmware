...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_MUTE,   KC_KP_0,  KC_KP_DOT,      TO(_WORK)
  ),
  ...
  KC_MUTE,   KC_T,  KC_GRV,      KC_ALTTOG \
  ),

   [_WORK] = LAYOUT(
        TO(_NUMPAD), KC_NO, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_JBTERM, KC_JBTESTS, KC_JBFORMAT_CODE, KC_NO, \
    KC_MUTE, KC_NO, KC_NO, KC_JBFOLD \
  ),
